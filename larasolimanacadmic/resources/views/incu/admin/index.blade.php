                                ...
                                <table id="attendenceDetailedTable" class="display responsive nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        <td class="action-link">
                                            <a class="edit EditIncuSubjectButton" href="#" title="Edit" data-toggle="modal" data-target="#editDetailModal" data-id="{{$admin->id}}"><i class="fa fa-edit"></i></a>
                                            <a class="delete DeleteIncuSubject" href="#" title="Delete" data-toggle="modal" data-target="#deleteDetailModal" data-id="{{$admin->id}}"><i class="fa fa-remove"></i></a>
                                        </td>
                                        <td>{{ $admin->admin }}</td>
                                        <td>{{ $admin->email }}</td>
                                        <td>{{ $admin->name }}</td>
                        ...
                        <div class="dash-item first-dash-item">
                            ...
                            <div class="inner-item">
                                <div class="dash-form">
                                    ...
                                    {!!Form::text('email','',['placeholder' => '','tabindex'=>'2','class'=>'Admin_email','email'])!!}
                                    <label><i class="fa fa-pause"></i>الباسورد</label>
                                    {!!Form::text('password','',['placeholder' => '','tabindex'=>'3','class'=>'Admin_password'])!!}
                                    <div>
                                        <button type="submit" class="btn submit_admin" tabindex="3"><a onclick="" class="noMargin"><i class="fa fa-paper-plane"></i> اضافة</a></button>
                                    </div>
                                </div>
